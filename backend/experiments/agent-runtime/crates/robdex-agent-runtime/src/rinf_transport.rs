...
fn selected_session_control_plane(
    ...
    Some(AgentRuntimeSelectedSessionControlPlane {
        ...
        role_version_id: session.role_version_id.clone().unwrap_or_default(),
...
fn agent_runtime_chat_entry(entry: &robdex_agent_runtime_projection::AgentRuntimeChatEntry) -> AgentRuntimeChatEntry {
    AgentRuntimeChatEntry {
        ...
        script_run_id: entry.script_run_id.clone(),
        stdout_artifact_id: entry.stdout_artifact_id.clone(),
        stderr_artifact_id: entry.stderr_artifact_id.clone(),
            ...
            .route("/state/snapshot", get(|| async {
                Json(RuntimeProjection {
                    ...
                    selected_session: Some(SelectedSessionDetail {
                        ...
                        role_version_id: Some("role-version-gui".to_string()),
                    ...
                    let delta = RuntimeDelta {
                        ...
                        kind: RuntimeDeltaKind::SessionUpsert {
                            session: SessionListItem {
                                ...
                                role_version: Some("1.0.0".to_string()),
                                role_version_id: Some("role-version-delta".to_string()),
                                project_key: None,
                                title: None,
                                name: None,
                                workdir: ".".to_string(),
            ...
            .route("/state/snapshot", get(|| async {
                Json(RuntimeProjection {
                    ...
                    sessions: vec![SessionListItem {
                        ...
                        role_id: Some("runtime-allow".to_string()),
                        role_version: Some("1.0.0".to_string()),
                        role_version_id: Some("role-version-pending".to_string()),
                        project_key: None,
                ...
                Json(RuntimeProjection {
                    ...
                    sessions: vec![
                        SessionListItem {
                            ...
                            role_version: Some("1.0.0".to_string()),
                            role_version_id: Some("role-version-zeta".to_string()),
                        ...
                        SessionListItem {
                            ...
                            role_id: Some("runtime-no-rg".to_string()),
                            role_version: Some("1.0.0".to_string()),
                            role_version_id: Some("role-version-alpha".to_string()),
                    ...
                    let delta = RuntimeDelta {
                        ...
                        kind: RuntimeDeltaKind::SessionUpsert {
                            session: SessionListItem {
                                ...
                                role_id: Some("runtime-no-rg".to_string()),
                                role_version: Some("1.0.0".to_string()),
                                role_version_id: Some("role-version-zeta-delta".to_string()),
                                project_key: Some("zeta-project".to_string()),
            ...
            .route("/state/snapshot", get(|| async {
                Json(RuntimeProjection {
                    ...
                    sessions: vec![SessionListItem {
                        ...
                        role_id: Some("runtime-no-rg".to_string()),
                        role_version: Some("1.0.0".to_string()),
                        role_version_id: Some("role-version-zeta-recovery".to_string()),
                        project_key: Some("zeta-project".to_string()),
        ...
        let projection = RuntimeProjection {
            ...
            selected_chat_entries: vec![
                ...
                robdex_agent_runtime_projection::AgentRuntimeChatEntry {
                    ...
                    script_run_id: Some("script-1".to_string()),
                    stdout_artifact_id: Some("stdout-1".to_string()),
                    stderr_artifact_id: Some("stderr-1".to_string()),
    ...
    fn dynamic_role_presentation_is_data_driven_not_fixed_codex_enum() {
        let view = AgentRuntimeWorkbenchViewModel {
            sessions: vec![AgentRuntimeWorkbenchSessionRow {
                ...
                status: "stopped".to_string(),
                role_version_id: "role-version-custom".to_string(),
