...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["cargo"].check(args=[]).start(); output("started " + h)'
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["cargo"].check(args=[]).start(); proc[h].terminate(); output("terminated " + h)'
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["rg"].run(args=["--files", "-g", "Cargo.toml"], cwd=".").start(); proc[h].input("forbidden"); output("bad")' || true
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: cmd["cargo"].check(args=[]).sync(); output("bad")' || true
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: files = cmd["rg"].run(args=["--files", "-g", "Cargo.toml"], cwd=".").sync(); output(files)'
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["rg"].run(args=["--files", "-g", "Cargo.toml"], cwd=".").start(); output("quick finite " + h)'
sleep 2
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["cargo"].check(args=[]).start(); output("durable max runtime " + h)'
sleep 1
...
run cargo run --quiet -- send --session "$SESSION" --message 'Use execute_code with exactly this Starlark source: h = cmd["rg"].run(args=["--files", "-g", "Cargo.toml"], cwd=".").start(); output("bad")' || true
