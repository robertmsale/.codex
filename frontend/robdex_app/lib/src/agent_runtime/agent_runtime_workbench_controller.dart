...
ChatEntry _chatEntry(bindings.AgentRuntimeChatEntry entry) {
  return ChatEntry(
    ...
    toolCallId: entry.hasToolCallId ? entry.toolCallId : null,
    scriptRunId: entry.hasScriptRunId ? entry.scriptRunId : null,
    stdoutArtifactId: entry.hasStdoutArtifactId ? entry.stdoutArtifactId : null,
    stderrArtifactId: entry.hasStderrArtifactId ? entry.stderrArtifactId : null,
