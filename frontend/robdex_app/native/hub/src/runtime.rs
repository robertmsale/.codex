...
use crate::signals::{
    ...
    AgentRuntimeSelectedSessionControlPlane, AgentRuntimeGodModeState,
    AgentRuntimeManagedProcessRow, AgentRuntimeApprovalCard, AgentRuntimeCommandRequestCard,
    AgentRuntimeRequirementsReviewPanel, AgentRuntimeActionAvailability,
...
fn typed_gui_operation(operation: AgentRuntimeGuiOperation) -> std::result::Result<GuiOperationRequest, ApiErrorPacket> {
    Ok(match operation {
        ...
        AgentRuntimeGuiOperation::CreateProject { project_key, display_name, default_workdir, default_worktree_root, default_role_id, default_model } => GuiOperationRequest::CreateProject {
            project_key,
            display_name,
            default_workdir,
        ...
        AgentRuntimeGuiOperation::UpdateProject { project_key, display_name, default_workdir, default_worktree_root, default_role_id, default_model } => GuiOperationRequest::UpdateProject {
            project_key,
            display_name,
            default_workdir,
            default_worktree_root,
