...
const mockAgentRuntimeDisconnected = AgentRuntimeControlTowerData(
  ...
  actionsSubtitle: 'Approvals and resumable runtime work',
...
const mockAgentRuntimeConnected = AgentRuntimeControlTowerData(
  ...
  statusBadges: [
    ...
    AgentRuntimeStatusBadge(label: 'Attention', value: '1', tone: 'warning'),
  ...
  actionsEmptyTitle: 'No action required',
  actionsEmptyText: 'No approvals or resumable runtime actions need attention.',
  sessions: [
