---
name: request-review
description: Use `request-review` for review-gated work. First run `request-review-role-instructions` so the current thread loads only the worker or orchestrator guidance it actually needs. MUST USE $command-execution SKILL WITH THIS PROCESS. [skill-hash:91e3b8c]
---
